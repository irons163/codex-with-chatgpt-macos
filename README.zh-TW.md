...
[English](README.md) | **繁體中文** | [简体中文](README.zh-CN.md) | [Français](README.fr.md) | [Español](README.es.md) | [日本語](README.ja.md) | [한국어](README.ko.md)
...
**macOS 13 以上，Apple Silicon / Intel。無 Node.js 或 npm。** App 與 CLI 都只在本機透過 CDP 操作桌面版介面，不會啟動 HTTP server、OAuth、MCP、tunnel 或公開連線；Sparkle 2 負責已簽署 App 的自動更新。
...
- 只掃描該 session 的工作目錄，工作區外檔案與 symlink 不會加入附件。
